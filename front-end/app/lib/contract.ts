 ...
 *
 * Mirror of backend/lib/contract.ts. Do not edit here — change the
 * backend copy and re-sync. The frontend is intentionally tolerant of
 * additive changes (new RunEvent variants, new optional fields on
 * existing types) — see app/lib/runReducer.ts for the unknown-event
 * fallthrough.
 *
 * (See backend/docs/Backend.md §2.)
 */
